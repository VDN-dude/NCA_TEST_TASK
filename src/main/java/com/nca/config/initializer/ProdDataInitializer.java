 ...
 * <P>A {@code ProdDataInitializer} implementation to initialize necessary .sql script.
...
public class ProdDataInitializer extends DataInitializer {
    ...
    @Override
    public String path() {
        return Objects.requireNonNull(this.getClass().getClassLoader().getResource("data/data-prod.sql")).getPath();
    }
}
